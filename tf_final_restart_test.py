...
# Step 1: Kill all tsensor processes first
...
# Step 2: Send proper CtlReq using Python (handles \n correctly)
print()
print('=== Send CtlReq RESTART via Python ===')
python_script = r"""
...
try:
    ...
    print("Body:", resp.read().decode("utf-8", errors="replace")[:200])
except Exception as e:
    print("ERROR:", str(e)[:300])
"""
i, o, e = c.exec_command("python3 << 'PYEOF'\n" + python_script + "\nPYEOF", timeout=30)
...
print()
print('=== Apache errors for recent actl ===')
i, o, e = c.exec_command("tail -10 /var/log/httpd/ly_error_log 2>/dev/null | head -5", timeout=10)
