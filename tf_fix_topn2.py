...
cmds = [
    ("Compile topn_req.cpp with -fpermissive", r"""
echo "=== Compile topn_req.cpp ==="
cd /root/SOC/ly_analyser_src/common

g++ -c -Wall -g -fPIC -std=c++17 -fpermissive -O2 -I. -I/usr/include -I/usr/local/include -I/usr/include/cgicc -I/usr/include/cppdb -o topn_req.o topn_req.cpp 2>&1 | grep -E "error:" | head -5
echo "Compile done"
ls -la topn_req.o 2>/dev/null && echo "OK: topn_req.o generated" || echo "FAIL: topn_req.o not generated"
"""),

    ("Repackage and verify libcommon", r"""
echo "=== Repackage libcommon ==="
cd /root/SOC/ly_analyser_src/common
...
echo "Object count: $(ar t libcommon.a | wc -l)"
echo ""
echo "=== Verify ComposeReqFilter symbol ==="
nm libcommon.a 2>/dev/null | grep "ComposeReqFilter" | head -3
nm -D libcommon.so 2>/dev/null | grep "ComposeReqFilter" | head -3
"""),

    ("Install libcommon.so", r"""
