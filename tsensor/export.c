...
void sendNetFlowV9V10(u_char lastFlow, u_char sendTemplate,
  ...
  V9FlowSet flowSet;
  /* Increased from 1472 (1514-42) to accommodate large templates with
     application-layer fields (HTTP, DNS, ICMP etc.) without overflow.
     Since traffic is typically sent to localhost collector, MTU is not a concern. */
  char flowBuffer[1600];
